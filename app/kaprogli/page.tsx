  ...
  return (
    <main className="mx-auto w-full max-w-5xl flex-1 px-6 py-12">
      ...
      <p className="mt-1 text-muted-foreground">
        Semester {SEMESTER}. Skor makin tinggi berarti kesenjangan antara materi ajar dan SKKNI
        makin besar — bukan pengukuran mutlak, gunakan bersama penilaian lapangan.
      </p>
